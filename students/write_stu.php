...
$sql = "INSERT INTO students (code, stu_name, stu_num, stu_pass, stu_con, stu_dep, stu_img, stu_ip, rdate)
VALUES(:code, :name, :number, :password, :content, :depart, :imglist, :ip, NOW())";
