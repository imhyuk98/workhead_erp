...
<main class="w-50 mx-auto border rounded-5 p-5">
    ...
    <div class="d-flex mt-3 gap-2 justify-content-between">
        ...
        <div class="w-50">
            ...
            <input type="password" class="form-control" id="f_password2" placeholder="비밀번호를 입력해주세요.">
        </div>
    </div>
    ...
    <div class="d-flex mt-3 gap-2 justify-content-between">
        <div class="w-50">
            ...
            <input type="text" class="form-control" id="f_addr1" placeholder="주소를 입력해주세요.">
        </div>
        <div class="w-50">
            <label for="f_addr2" class="form-label">상세주소</label>
            <input type="text" class="form-control" id="f_addr2" placeholder="상세주소를 입력해주세요.">
        </div>
    </div>

    <div class="mt-3 d-flex gap-5">
        <div><input type="file" name="profile" class="form-control"></div>
        <img src="images/person.jpeg" class="w-25" alt="profile image">
    </div>
